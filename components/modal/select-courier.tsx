...
export const SelectCourier: FunctionComponent<props> = ({
  ...
  <Dialog
    open={isOpen}
    onClose={onClose}
    className="fixed inset-x-0 bottom-0 z-50 max-w-lg px-4 py-6 mx-auto overflow-y-auto bg-white border-t shadow-md md:border-t-0 md:rounded-lg md:bottom-6 lg:px-6"
  >
    <Dialog.Overlay />
    <Dialog.Title>
      <div>
