    ...
    <>
      ...
      <div className=" md:mb-12 flex justify-between ">
        <div className="flex flex-row items-center">
          <div>
            <Avatar className="text-primary" name="dummy name" picture="https://awsimages.detik.net.id/community/media/visual/2021/05/27/presiden-jokowi_169.jpeg?w=700&q=90" />
          </div>
